      ...
      <section className="space-y-6 pb-8 pt-6 mb-0 md:pb-12 md:py-20 lg:py-32 h-screen flex items-center">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center -mt-20">
          <Image
            ...
            alt={`${siteConfig.authorName} - Full-Stack & AI Engineer Portfolio`}
            priority
          />
          <AnimatedText
            as="h1"
          ...
          <div className="mt-4 max-w-[42rem] text-center">
            <p className="leading-normal text-muted-foreground text-sm sm:text-base">
              Full-stack and AI engineer with 5+ years of experience building
              Python web applications, backend systems, and machine learning
              services.
            </p>
          </div>
      ...
      >
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          ...
          <AnimatedText
            as="p"
            delay={0.2}
            className="max-w-[70rem] leading-normal text-muted-foreground sm:text-lg sm:leading-8"
          >
            {aboutConfig.paragraphs[0]}
          </AnimatedText>
        </div>
        <AnimatedText delay={0.4} className="flex justify-center">
          <Link href="/about">
            <Button variant={"outline"} className="rounded-xl">
              <Icons.chevronDown className="mr-2 h-4 w-4" /> Read More
            </Button>
          </Link>
        </AnimatedText>
      </AnimatedSection>
        ...
        <div className="mx-auto grid justify-center gap-4 md:w-full lg:grid-cols-2">
          {education.map((edu, index) => (
            <AnimatedSection
              ...
              className="h-full w-full min-w-0"
            >
              <div className="h-full p-4 sm:p-6 bg-background border border-border rounded-lg">
